...
export const PricingCard: React.FC<PricingCardProps> = ({ currentFounders }) => {
  const features = [
    ...
    },
    {
      ...
      description: "Group sessions with our expert team"
    },
    {
  ...
  return (
    <div className="max-w-5xl mx-auto mb-16">
      ...
      >
        ...
        <div className="glass-card rounded-3xl border border-emerald-500/30 backdrop-blur-xl relative overflow-hidden bg-black/40 mt-6 sm:mt-0">
          {/* Gradient Orbs */}
          <div className="absolute -top-24 -right-24 w-48 h-48 bg-emerald-500/20 rounded-full blur-3xl" />
          <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-purple-500/20 rounded-full blur-3xl" />
          
          <div className="relative grid md:grid-cols-2 gap-8 p-4 sm:p-8">
            {/* Left Column - Features */}
            <div>
              <div className="text-center md:text-left mb-8">
                <h3 className="text-2xl sm:text-3xl font-bold mb-2 text-white">Founder's Lifetime Access</h3>
            ...
            <div className="flex flex-col">
              ...
              <div className="glass-card rounded-2xl p-6 mb-6 text-center bg-black/60 border border-emerald-500/30">
                <div className="flex items-center justify-center gap-4 mb-4">
                  ...
                  <div className="text-left">
                    <div className="text-base sm:text-lg text-gray-400 line-through">$3,480/year</div>
                    <div className="text-base sm:text-lg text-emerald-400 font-medium">Save 85%</div>
                  </div>
                </div>
              ...
              {/* Speed Bonuses */}
              <div className="glass-card rounded-2xl p-4 sm:p-6 mb-6 bg-black/60 border border-purple-500/30">
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-4">
                <div className="text-center p-2 sm:p-4 glass-card rounded-xl bg-black/60 border border-emerald-500/20">
                  <Users className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-400 mx-auto mb-1 sm:mb-2" />
                  <div className="text-xl sm:text-2xl font-bold text-white">{currentFounders}/100</div>
                  <div className="text-xs sm:text-sm text-gray-300">Founders</div>
                </div>
                <div className="text-center p-2 sm:p-4 glass-card rounded-xl bg-black/60 border border-purple-500/20">
                  <Gift className="w-5 h-5 sm:w-6 sm:h-6 text-purple-400 mx-auto mb-1 sm:mb-2" />
                  <div className="text-xl sm:text-2xl font-bold text-white">$3,000+</div>
                  <div className="text-xs sm:text-sm text-gray-300">Prize Pool</div>
                </div>
                <div className="text-center p-2 sm:p-4 glass-card rounded-xl bg-black/60 border border-emerald-500/20">
                  <Star className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-400 mx-auto mb-1 sm:mb-2" />
                  <div className="text-xl sm:text-2xl font-bold text-white">4</div>
                  <div className="text-xs sm:text-sm text-gray-300">Milestones</div>
                </div>
              </div>
            </div>
          </div>
